    ...
    <div className="h-80 flex flex-row">
      <div className="w-1/2 flex flex-row">
        <div className="w-1/2 bg-secondary flex flex-col justify-center items-center text-center px-14">
          <div className="text-white text-2xl mb-2">EQUIPOS DE CARGIO</div>
          <div className="text-white text-[15px]">Máquinas de última tecnología para una carga eficiente y segura.</div>
        </div>
        <div className="w-1/2 flex flex-col items-center justify-between py-6">
          <div className="h-2"></div>
          <div className="flex flex-col justify-center items-center mb-6">
            <span className="text-5xl font-bold mb-3">+20</span>
