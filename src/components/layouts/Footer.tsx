...
const Footer = () => {
  return (
    <div className="flex flex-row bg-footer py-20 px-16">
      ...
      <div className="w-1/2 text-white flex flex-row gap-6">
        <div className="w-1/3">
        ...
        <h2 className='text-3xl font-bold mb-6'>Contáctanos</h2>
          <ul>
            <li className='text-[18px] mb-3 flex flex-row items-center'>
              <Phone className='w-7 h-7 mr-3'/>
              <span >+51 995 964 600</span>
            </li>
            <li className='text-[18px] mb-2 flex flex-row items-center'>
